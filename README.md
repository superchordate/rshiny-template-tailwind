...
You'll notice I don't follow normal R conventions like using `<-` and seemingly random selection of `'` and `"` (as a result of mixing AI results with my personal preference for `'` because it doesn't require the shift key). 
